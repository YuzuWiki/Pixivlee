...
func (P PixivApi) AccountInfo(p IPixiver) (data *ResponseData[User], err error) {
	r := pixivRequest(p)
...
func (P PixivApi) ProfileAll(p IPixiver, pid TPid) (data *ResponseData[ProfileAll], err error) {
...
func (P PixivApi) ProfileTop(p IPixiver, pid TPid) (data *ResponseData[ProfileTop], err error) {
	r := pixivRequest(p).SetSuccessResult(&data)
...
func (P PixivApi) artWork(p IPixiver, artType string, artIId TArtId) (data *ResponseData[ArtWork], err error) {
	r := pixivRequest(p).SetSuccessResult(&data)
...
func (P PixivApi) ArtWorkIllust(p IPixiver, artId TArtId) (*ResponseData[ArtWork], error) {
	return P.artWork(p, ArtTypeIllust, artId)
}

func (P PixivApi) ArtWorkManga(p IPixiver, artId TArtId) (*ResponseData[ArtWork], error) {
	return P.artWork(p, ArtTypeManga, artId)
}

func (P PixivApi) ArtWorkNovel(p IPixiver, artId TArtId) (*ResponseData[ArtWork], error) {
	return P.artWork(p, ArtTypeNovel, artId)
}

func (P PixivApi) bookmarks(p IPixiver, rest string, pid TPid, tag string, offset, limit int) (data *ResponseData[Bookmark], err error) {
	r := pixivRequest(p).
...
func (P PixivApi) BookmarkShow(p IPixiver, pid TPid, tag string, offset, limit int) (*ResponseData[Bookmark], error) {
	return P.bookmarks(p, RestTypeShow, pid, tag, offset, limit)
}

func (P PixivApi) BookmarkHide(p IPixiver, pid TPid, tag string, offset, limit int) (*ResponseData[Bookmark], error) {
...
func (P PixivApi) followedLast(p IPixiver, mode string, page int) (data *ResponseData[FollowLatestDTO], err error) {
	r := pixivRequest(p).
...
func (P PixivApi) FollowedLastIllust(p IPixiver, page int) (*ResponseData[FollowLatestDTO], error) {
	return P.followedLast(p, ArtTypeIllust, page)
}

func (P PixivApi) FollowedLastManga(p IPixiver, page int) (*ResponseData[FollowLatestDTO], error) {
	return P.followedLast(p, ArtTypeManga, page)
}

func (P PixivApi) FollowedLastNovel(p IPixiver, page int) (*ResponseData[FollowLatestDTO], error) {
	return P.followedLast(p, ArtTypeNovel, page)
}

func (P PixivApi) FollowingList(p IPixiver, pid TPid, limit int, offset int) (data *ResponseData[Following], err error) {
...
func (P PixivApi) TagSearch(p IPixiver, jpName string) (data *ResponseData[Tag], err error) {
	r := pixivRequest(p).SetSuccessResult(&data)
...
func (P PixivApi) rank(p IPixiver, mode string, content string, page int, date string) (data *RankJson, err error) {
	r := pixivRequest(p).
		SetSuccessResult(&data).
...
func (P PixivApi) RankALL(p IPixiver, mode string, page int, date string) (*RankJson, error) {
	switch mode {
...
func (P PixivApi) RankIllust(p IPixiver, mode string, page int, date string) (*RankJson, error) {
	switch mode {
	case RankDaily, RankDailyR18:
	case RankWeekly, RankWeeklyR18:
	case RankMonthly:
...
func (P PixivApi) RankUgoira(p IPixiver, mode string, page int, date string) (*RankJson, error) {
	switch mode {
	case RankDaily, RankDailyR18:
	case RankWeekly, RankWeeklyR18:
	default:
...
func (P PixivApi) RankManga(p IPixiver, mode string, page int, date string) (*RankJson, error) {
	switch mode {
	case RankDaily, RankDailyR18:
	case RankWeekly, RankWeeklyR18:
	case RankMonthly:
