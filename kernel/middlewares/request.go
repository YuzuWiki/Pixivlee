...
func DefaultRequest(ua, referer, host string) func(iClient httpx.ISession, iRequest httpx.IRequest) error {
	ua = strings.TrimSpace(ua)
	if ua == "" {
		ua = DEFAULT_USER_AGENT
	}

	return func(iClient httpx.ISession, iRequest httpx.IRequest) error {
